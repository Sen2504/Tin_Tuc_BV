          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <h1 className="text-2xl font-extrabold leading-tight text-gray-800 lg:text-3xl">
                Bệnh viện <span className="text-sky-500">Phục hồi chức năng</span>
              </h1>
            </div>
          ...
          {menuItems.map((item, index) => (
            ...
            <div key={item.id} className="border-b border-gray-100">
              ...
              <button
                ...
                className="flex w-full items-center justify-between px-5 py-3 text-sm font-semibold text-gray-700 transition hover:text-sky-600"
              >
                {item.name}
